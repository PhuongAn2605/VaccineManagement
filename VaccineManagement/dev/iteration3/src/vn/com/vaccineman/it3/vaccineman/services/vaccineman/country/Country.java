package vn.com.vaccineman.it3.vaccineman.services.vaccineman.country;
...
public class Country {
	...
	public Country(@AttrRef("name")String name,
			  @AttrRef("population" )Long population) throws ConstraintViolationException {
		this(null, name,population);
