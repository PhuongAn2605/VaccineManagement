package vn.com.vaccineman.it3.vaccineman.services.vaccineman.vaccine.report;
...
/**
 * @overview 
 * 	Represent the reports about Vaccines by name.
 * 
 * @author dmle
 *
 * @version 5.0
...
public class VaccineByNameReport {
  ...
  @DAttr(name="vaccines",type=Type.Collection,optional=false, mutable=false,
      ...
      attributes={Vaccine.A_id, Vaccine.A_name, Vaccine.A_producer, Vaccine.A_nature, 
          Vaccine.A_injectionProtocol, Vaccine.A_price, Vaccine.A_averageEvaluation,
          Vaccine.A_averageEvaluation, Vaccine.A_rptVaccineByName})
      ,derivedFrom={"name"}
      )
