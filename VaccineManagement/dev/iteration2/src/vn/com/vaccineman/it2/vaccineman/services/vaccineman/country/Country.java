package vn.com.vaccineman.it2.vaccineman.services.vaccineman.country;
...
public class Country {
	...
	@DAttr(name = A_population, type = Type.Long, length = 10, optional = false)
	  private long population;
	
	@DAttr(name = A_infectedPeopleNum, type = Type.Long, length = 10, optional = false)
...
//			  }
		...
		public void setInfectedPeopleNum(long infectedPeopleNum) {
			this.infectedPeopleNum = infectedPeopleNum;
		}
