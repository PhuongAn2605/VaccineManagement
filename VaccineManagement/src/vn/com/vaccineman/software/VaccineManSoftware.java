package vn.com.vaccineman.software;
...
import vn.com.vaccineman.services.enums.PeopleGroup;
...
import vn.com.vaccineman.services.injectionman.person.report.PeopleByNameReport;
...
import vn.com.vaccineman.services.injectionman.registration.report.RegistrationsByDateReport;
import vn.com.vaccineman.services.injectionman.staff.address.Address;
...
import vn.com.vaccineman.services.injectionman.staff.model.SupportStaff;
...
import vn.com.vaccineman.services.vaccineman.storage.report.RemainVaccineQuantityReportEqualLessThan;
...
import vn.com.vaccineman.services.vaccineman.trial.report.TrialEfficacyEqualGreaterThan;
import vn.com.vaccineman.services.vaccineman.trial.report.TrialEfficacyEqualLessThan;
import vn.com.vaccineman.services.vaccineman.trial.report.TrialByVaccineEvaluationAndPeoleGroupReport;
import vn.com.vaccineman.services.vaccineman.vaccine.model.FreeVaccine;
import vn.com.vaccineman.services.vaccineman.vaccine.model.PriceVaccine;
...
import vn.com.vaccineman.services.vaccineman.vaccineCenter.report.VaccineCenterCapacityEqualGreaterThanReport;
...
//	      InjectionsByDateReport.class,
	  ...
	  /* (non-Javadoc)
	   * @see vn.com.vaccineman.it2.courseman.software.Software#getModel()
	   */
	  /**
	   * @effects 
	   *  return {@link #model}.
...
//		    createInjection(sw);
	  ...
	  private static void createCountry(DomSoftware sw) throws NotFoundException, DataSourceException {
		...
		Country country = new Country("Vietnam", 920000L, 3000L);
		sw.addObject(Country.class, country);
	}
	  private static void createSupplier(DomSoftware sw) throws NotFoundException, DataSourceException {
//		  	Country swl = new Country("Switzerland", 10000000L, 300L);
			Country country = sw.retrieveObjectById(Country.class, 1);
			Supplier supplier = new Supplier("ACT Accelerator", "COVAX", country);
			sw.addObject(Supplier.class, supplier);
		}
	  ...
	  private static void createFreeVaccine(DomSoftware sw) throws NotFoundException, DataSourceException {
		  Country producer = sw.retrieveObjectById(Country.class, 1);
			FreeVaccine freeVaccine = new FreeVaccine("Pfizer-BioNTech", producer, "whole", "AAA");
