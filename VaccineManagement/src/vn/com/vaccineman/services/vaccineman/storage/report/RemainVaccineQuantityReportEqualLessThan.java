package vn.com.vaccineman.services.vaccineman.storage.report;
...
public class RemainVaccineQuantityReportEqualLessThan {
	@DAttr(name = "id", id = true, auto = true, type = Type.Integer, length = 5, optional = false, mutable = false)
	  ...
	  public RemainVaccineQuantityReportEqualLessThan(@AttrRef("remainQuantity") Long remainQuanity) throws NotPossibleException, DataSourceException {
	    this.id=++idCounter;
...
//	    boolean doReportQuery = (name != null && !name.equals(this.name));
	  ...
	  public boolean equals(Object obj) {
	    ...
	    if (getClass() != obj.getClass())
	      return false;
	    RemainVaccineQuantityReportEqualLessThan other = (RemainVaccineQuantityReportEqualLessThan) obj;
	    if (id != other.id)
	      return false;
	    return true;
	  }
