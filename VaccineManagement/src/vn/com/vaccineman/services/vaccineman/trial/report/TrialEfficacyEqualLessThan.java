...
public class TrialEfficacyEqualLessThan {
	@DAttr(name = "id", id = true, auto = true, type = Type.Integer, length = 5, optional = false, mutable = false)
	  ...
	  @DAttr(name="trials",type=Type.Collection,optional=false, mutable=false,
	      ...
	      attributes={Trial.A_id, Trial.A_name, Trial.A_vaccine, Trial.A_startDate, 
	    		  Trial.A_endDate,Trial.A_trackingDays, Trial.A_trialEfficacy, Trial.A_evaluation,Trial.A_rptTrialEfficacyLessThan})
	      ,derivedFrom={"trialEfficacy"}
	      )
	  @DAssoc(ascName="trials-by-efficacy-lessThan-report-has-trials",role="report",
	  ...
	  public TrialEfficacyEqualLessThan(@AttrRef("trialEfficacy") Double trialEfficacy) throws NotPossibleException, DataSourceException {
	    this.id=++idCounter;
...
//	    boolean doReportQuery = (name != null && !name.equals(this.name));
	  ...
	  public boolean equals(Object obj) {
	    ...
	    if (getClass() != obj.getClass())
	      return false;
	    TrialEfficacyEqualLessThan other = (TrialEfficacyEqualLessThan) obj;
	    if (id != other.id)
	      return false;
	    return true;
	  }
