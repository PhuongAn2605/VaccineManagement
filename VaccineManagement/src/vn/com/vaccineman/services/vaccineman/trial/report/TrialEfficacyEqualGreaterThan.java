...
public class TrialEfficacyEqualGreaterThan {
	@DAttr(name = "id", id = true, auto = true, type = Type.Integer, length = 5, optional = false, mutable = false)
	  ...
	  public TrialEfficacyEqualGreaterThan(@AttrRef("trialEfficacy") Double trialEfficacy) throws NotPossibleException, DataSourceException {
	    this.id=++idCounter;
...
//	    boolean doReportQuery = (name != null && !name.equals(this.name));
	  ...
	  public boolean equals(Object obj) {
	    ...
	    if (getClass() != obj.getClass())
	      return false;
	    TrialEfficacyEqualGreaterThan other = (TrialEfficacyEqualGreaterThan) obj;
	    if (id != other.id)
	      return false;
	    return true;
	  }
