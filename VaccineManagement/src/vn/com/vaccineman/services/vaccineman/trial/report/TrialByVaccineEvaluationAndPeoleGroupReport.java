package vn.com.vaccineman.services.vaccineman.trial.report;
...
public class TrialByVaccineEvaluationAndPeoleGroupReport {
	@DAttr(name = "id", id = true, auto = true, type = Type.Integer, length = 5, optional = false, mutable = false)
	  private int id;
	  private static int idCounter = 0;
	  
	  @DAttr(name = "vaccine", type = Type.String, length = 20, optional = false)
	  ...
	  @DAttr(name="trials",type=Type.Collection,optional=false, mutable=false,
	      ...
	      attributes={Trial.A_id, Trial.A_name, Trial.A_vaccine, Trial.A_startDate, 
	    		  Trial.A_endDate,Trial.A_trackingDays, Trial.A_trialEfficacy, Trial.A_rptTrialEvaluationAndPeopleGroup})
	      ,derivedFrom={Trial.A_vaccine, Trial.A_evaluation, Trial.A_peopleGroup}
	      )
	  ...
	  public TrialByVaccineEvaluationAndPeoleGroupReport(
			  @AttrRef("vaccine") String vaccine,
	...
	/**
	  ...
	  public void doReportQuery() throws NotPossibleException, DataSourceException {
		    ...
		    Query q2 = QueryToolKit.createSearchQuery(dsm, Trial.class,
		    		new String[] {Trial.A_peopleGroup}, 
		            new Op[] {Op.MATCH}, 
		            new Object[] {peopleGroup});
		    
		    Query q3 = QueryToolKit.createSimpleJoinQuery(dsm, Trial.class, Vaccine.class,  
		            Trial.A_vaccine, 
		            Vaccine.A_name, 
		            Op.MATCH, 
		            "%"+vaccine+"%");
...
//		            		SideEffect.Others});
		        ...
		        Map<Oid, Trial> result2 = qrm.getDom().retrieveObjects(Trial.class, q2);
		        Map<Oid, Trial> result3 = qrm.getDom().retrieveObjects(Trial.class, q3);
		        Map<Oid, Trial> result = new HashMap<>();
		        
		        if(result1 != null && result2 != null && result3 != null) {
		        	for(Map.Entry<Oid, Trial> entry : result1.entrySet()) {
		        		if(result2.containsValue(entry.getValue()) && result3.containsValue(entry.getValue())) {
	  ...
	  public boolean equals(Object obj) {
	    ...
	    if (getClass() != obj.getClass())
	      return false;
	    TrialByVaccineEvaluationAndPeoleGroupReport other = (TrialByVaccineEvaluationAndPeoleGroupReport) obj;
	    if (id != other.id)
	      return false;
	    return true;
	  }
