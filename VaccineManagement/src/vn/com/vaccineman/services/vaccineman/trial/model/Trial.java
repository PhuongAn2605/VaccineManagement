package vn.com.vaccineman.services.vaccineman.trial.model;
...
public class Trial {
	...
	@DAttr(name = A_vaccine, type = Type.Domain, length = 15, optional = false)
	...
	@DAttr(name=A_rptTrialEvaluationAndPeopleGroup,type=Type.Domain, serialisable=false, virtual=true)
		  private TrialByVaccineEvaluationAndPeoleGroupReport rptTrialEvaluationAndPeopleGroup;
	
	@DAttr(name=A_rptTrialEfficacyGreaterThan,type=Type.Domain, serialisable=false, virtual=true)
	  private TrialEfficacyEqualGreaterThan rptTrialEfficacyGreaterThan;
	
	@DAttr(name=A_rptTrialEfficacyLessThan,type=Type.Domain, serialisable=false, virtual=true)
	  private TrialEfficacyEqualLessThan rptTrialEfficacyLessThan;
	...
	public Trial(
		...
		this(null, name,vaccine, peopleGroup, startDate, endDate, trackingDays, details, trialEfficacy, null);
	...
	public Trial(
			  ...
			  @AttrRef("details")String details,
			  @AttrRef("trialEfficacy")Double trialEfficacy) throws ConstraintViolationException {
		this(null, name,vaccine, peopleGroup, startDate, endDate, 0, details, trialEfficacy, null);
	}
	...
	public Trial(
			  ...
			  @AttrRef("endDate")Date endDate,
			  @AttrRef("trialEfficacy")Double trialEfficacy) throws ConstraintViolationException {
		this(null, name,vaccine, peopleGroup, startDate, endDate, 0, null, trialEfficacy, null);
...
//		}
		...
		public boolean setTrialEfficacy(double trialEfficacy) {
			this.trialEfficacy = trialEfficacy;
			stateHist.put(A_trialEfficacy, trialEfficacy);
			updateEvaluation();
		...
		public TrialByVaccineEvaluationAndPeoleGroupReport getRptTrialEvaluationAndPeopleGroup() {
			return rptTrialEvaluationAndPeopleGroup;
		}

		
		public TrialEfficacyEqualGreaterThan getRptTrialEfficacyGreaterThan() {
			return rptTrialEfficacyGreaterThan;
		}


		public TrialEfficacyEqualLessThan getRptTrialEfficacyLessThan() {
		...
		public String toString() {
			return "Trial [id=" + id + ", name=" + name + ", vaccine=" + vaccine + ", peopleGroup="
