package vn.com.vaccineman.services.vaccineman.vaccineCenter.report;
...
public class VaccineCenterCapacityEqualGreaterThanReport {
	@DAttr(name = "id", id = true, auto = true, type = Type.Integer, length = 5, optional = false, mutable = false)
	  ...
	  public VaccineCenterCapacityEqualGreaterThanReport(@AttrRef("capacity")Double capacity) throws NotPossibleException, DataSourceException {
	    this.id=++idCounter;
...
//	    boolean doReportQuery = (name != null && !name.equals(this.name));
	  ...
	  public boolean equals(Object obj) {
	    ...
	    if (getClass() != obj.getClass())
	      return false;
	    VaccineCenterCapacityEqualGreaterThanReport other = (VaccineCenterCapacityEqualGreaterThanReport) obj;
	    if (id != other.id)
	      return false;
	    return true;
	  }
