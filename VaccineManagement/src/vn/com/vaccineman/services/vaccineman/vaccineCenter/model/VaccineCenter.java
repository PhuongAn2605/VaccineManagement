package vn.com.vaccineman.services.vaccineman.vaccineCenter.model;
...
//	  private Address address;
	  ...
	  @DAttr(name = A_totalArea, type = Type.Double, length = 10, optional = false, min=0)
	  private double totalArea;
	  
	  @DAttr(name = A_capacity, type = Type.Double, length = 30, optional = false, min=0)
	  ...
	  @DAttr(name=A_rptVaccineCenterCapacityGreaterThan,type=Type.Domain, serialisable=false, virtual=true)
	  private VaccineCenterCapacityEqualGreaterThanReport rptVaccineCenterCapacityGreaterThan;
...
//	}
	...
	public VaccineCenterCapacityEqualGreaterThanReport getRptVaccineCenterCapacityGreaterThan() {
				return rptVaccineCenterCapacityGreaterThan;
			}
