...
//	}
	...
	public PriorityPerson(@AttrRef("name")String name, 
		...
		this(null, name, dob, 0, null, null, phoneNumber, healthStatus, null, null, job);
	}
	...
	public PriorityPerson(@AttrRef("name")String name, 
			...
			@AttrRef("healthStatus")HealthStatus healthStatus, 
			@AttrRef("job")String job) {
		this(null, name, dob,0, gender, null, phoneNumber,healthStatus, null, null, job);
	}
	...
	public PriorityPerson(@AttrRef("name")String name, 
			...
			@AttrRef("job")String job) {
		this(null, name, dob, 0, gender, injectRegion, phoneNumber, healthStatus, registration, injection, job);
	}
	...
	public PriorityPerson(
			...
			@AttrRef("injection") Injection injection,
			@AttrRef("job")String job) {
		super(id, name, dob, age, gender, injectRegion, phoneNumber, healthStatus, registration, injection);
		this.job = job;
	}
