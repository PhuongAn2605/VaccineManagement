...
public abstract class Person {
	...
	@DAttr(name = A_name, type = Type.String, length =20, optional = false, cid=true)
	  ...
	  @DAttr(name =A_age, type = Type.Integer, length = 10, optional = true, mutable = false, auto = true, serialisable = true, 
				derivedFrom = { A_dob })
	  private int age;
...
//		private Registration registration;
  ...
  associate=@Associate(type=Injection.class,cardMin=1,cardMax=1))
	...
	public Person(@AttrRef("name")String name, 
		...
		this(null, name, dob, 0, null, null, phoneNumber,healthStatus, null,null);
	}
	  ...
	  @DOpt(type=DOpt.Type.ObjectFormConstructor)
		public Person(@AttrRef("name")String name, 
				...
				@AttrRef("phoneNumber")String phoneNumber,
				@AttrRef("healthStatus")HealthStatus healthStatus) {
			this(null, name, dob, 0, gender, injectRegion, phoneNumber,healthStatus, null,null);
		}
	  ...
	  @DOpt(type=DOpt.Type.ObjectFormConstructor)
		public Person(@AttrRef("name")String name, 
			...
			this(null, name, dob, 0, gender, injectRegion, phoneNumber,healthStatus, null, injection);
		}
	  ...
	  @DOpt(type=DOpt.Type.ObjectFormConstructor)
		public Person(@AttrRef("name")String name, 
			...
			this(null, name, dob, 0, gender, injectRegion, phoneNumber,healthStatus, registration, null);
		}
	  ...
	  @DOpt(type=DOpt.Type.ObjectFormConstructor)
		public Person(@AttrRef("name")String name, 
				...
				@AttrRef("phoneNumber")String phoneNumber,
				@AttrRef("healthStatus")HealthStatus healthStatus) {
			this(null, name, dob,0, gender,null, phoneNumber,healthStatus,null, null);
		}
	  ...
	  @DOpt(type=DOpt.Type.ObjectFormConstructor)
		public Person(@AttrRef("name")String name, 
				...
				@AttrRef("registration")Registration registration,
				@AttrRef("injection") Injection injection) {
			this(null, name, dob, 0, gender, injectRegion, phoneNumber,healthStatus, registration, injection);
		}
...
//	}
	...
	public void updateAge() {
		if(dob != null) {
			...
			int p = Calendar.getInstance().get(Calendar.YEAR) - year;
