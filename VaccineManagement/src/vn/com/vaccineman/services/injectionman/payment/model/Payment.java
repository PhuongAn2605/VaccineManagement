package vn.com.vaccineman.services.injectionman.payment.model;
...
//	  associate=@Associate(type=Registration.class,cardMin=1,cardMax=1))
	...
	public Payment(
		...
		this(null, payDate, accountant, registration, null, null, 0, 0D, 0D, 0D, null, null);
	}
	...
	public Payment(
		...
		this(null, payDate, accountant, registration, null, null, 0, 0D, inputMoney, 0D,null, null);
	}
	...
	public Payment(
		...
		this(null, payDate, accountant, registration, registeredPerson, vaccineType, quantity, vaccinePrice, inputMoney, returnMoney, null, status);
